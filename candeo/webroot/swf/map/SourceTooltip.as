...
package map {
	 ...
	 *	@since  2008-05-13
	 */
	public class SourceTooltip extends Sprite {
		...
		public var sourceDanger				:SourceDanger;
		...
		//  CONSTRUCTOR
		//--------------------------------------
		public function SourceTooltip(_dc){
			//--------------------------------------
			//  DEFINITIONS
			//--------------------------------------
			dc								= _dc;
		...
		//  METHODS
		//--------------------------------------
		public function addSourceTooltip(_target):void{
			sourceDanger = _target;
			pTarget = _target.sourcePoint;
			displayTooltip(_target);
			positionTooltip();
			TweenLite.to(this, 1, {alpha:1, ease:Strong.easeOut}); 
		} // END addTooltip()
		
		public function removeSourceTooltip():void{
		...
		public function positionTooltip():void{
			...
			if(xRight > dc.stage.stageWidth-250){
		...
		public function setNames():void{
			dangerName.text = sourceDanger.potential.record.daten.name.toString();
		} // END setNames()
		
		public function setVariables():void{
			dangerVariable.text		= sourceDanger.potential.record.potential.toString();
		} // END setVariables()
		
		public function configureContent():void{
			switch(sourceDanger.potential.record.daten.sourcetype.toString()){
				case "Atomic":
